...
ENV FOSSIL_INSTALL_VERSION version-2.12.1
...
CMD ["/usr/bin/fossil", "server", "--https", "--create", "--user", "admin", "/opt/fossil/repository.fossil"]
CMD ["/usr/bin/fossil", "user", "password", "-R", "/opt/fossil/repository.fossil", "admin", "admin"]
